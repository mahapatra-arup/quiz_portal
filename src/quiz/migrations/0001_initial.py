# Generated by Django 2.2.6 on 2020-08-14 02:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('featured_image', models.ImageField(blank=True, null=True, upload_to='exam/images/%Y/%m/')),
                ('slug', models.SlugField(default=uuid.uuid4, help_text='The name of the page as it will appear in URLs e.g http://domain.com/blog/[my-slug]/', max_length=100, unique=True)),
                ('created_on', models.DateTimeField(auto_now_add=True)),
                ('updated_on', models.DateField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter meaningfull Question-Set Name like "2020-Bengali-Set-I"', max_length=150)),
                ('order_by', models.PositiveIntegerField(default=0)),
                ('is_active', models.BooleanField(default=True)),
                ('slug', models.SlugField(default=uuid.uuid4, help_text='The name of the page as it will appear in URLs e.g http://domain.com/blog/[my-slug]/', max_length=100, unique=True)),
                ('created_on', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_set', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='quiz.Question_Set')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img_option', models.FileField(blank=True, null=True, upload_to='question/option_img/%Y/%m/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_set', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='quiz.Question_Set')),
        ...
        migrations.AddField(
            model_name='exam',
            name='questionpaper',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='quiz.QuestionPaper'),
        ),
    ]
